...
local Text = ' 👽تم ارسال الملصق من 𖤍━┅┄⟞⟦꧁ASFINX ꧂⟧⟝┄┉━𖤍\n - '..Name
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 👽 اصدار سورس اسفينكس{ 3x☆}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'مطورين السورس👽', url="t.me/SAORS6"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmmmm_70/1937&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 👽 من أحسن السورسات على التليجرام سورس اسفينكس 👽
...
send(msg.chat_id_,0," 👽 الـعـضو  : {["..data.first_name_.."](T.ME/mmmmm_70)}\n 👽 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 👽 عذرا  ⇇{["..data.first_name_.."](T.ME/mmmmm_70)}\n 👽 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[  
 👽 اهلا في قائمه الالعاب المتطوره سورس اسفينكس 👽 
...
send(msg.chat_id_, msg.id_, " 👽 لا تسطيع حظر الاجنبي اليكس")
return false 
end
...
send(msg.chat_id_, msg.id_, " 👽 لا تسطيع حظر جاكسون الكبير")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1842376997) then  
send(msg.chat_id_, msg.id_, " 👽 لا تسطيع حظر جاكسون الاجنبي")
return false 
end
...
function(arg,data) 
usertext = '\n 👽 الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'mmmmm_70')..')'
...
usertext = '\n 👽 الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'mmmmm_70')..')'
status  = '\n 👽 تم حظرو عام من الجروبات '
texts = usertext..status
...
send(msg.chat_id_, msg.id_, " 👽 لا تسطيع حظر الاجنبي اليكس عام")
return false 
end
...
send(msg.chat_id_, msg.id_, " 👽 لا تسطيع حظر جاكسون الكبير عام")
return false 
end
if tonumber(userid) == tonumber(1842376997) then  
send(msg.chat_id_, msg.id_, " 👽 لا تسطيع حظر جاكسون اليكس عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1805936474) then  
send(msg.chat_id_, msg.id_, " 👽 لا تسطيع كتم الاجنبي اليكس")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1737072779) then  
send(msg.chat_id_, msg.id_, " 👽 لا تسطيع كتم جاكسون الكبير")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1842376997) then  
send(msg.chat_id_, msg.id_, " 👽 لا تسطيع كتم جاكسون اليكس")
return false 
end
...
if result.id_ == tonumber(1805936474) then
send(msg.chat_id_, msg.id_, " 👽 لا يمكنك كتم الاجنبي \n")
return false 
end
if result.id_ == tonumber(1859008079) then
...
if result.id_ == tonumber(1737072779) then
send(msg.chat_id_, msg.id_, " 👽 لا يمكنك كتم جاكسون الكبير \n")
return false 
end
if result.id_ == tonumber(1842376997) then
send(msg.chat_id_, msg.id_, " 👽 لا يمكنك كتم جاكسون الاجنبي \n")
return false 
end
usertext = '\n 👽 الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'mmmmm_70')..')'
status  = '\n 👽 تم كتمه عام من الجروبات'
...
if tonumber(userid) == tonumber(1805936474) then  
send(msg.chat_id_, msg.id_, " 👽 لا تسطيع كتم الاجنبي اليكس عام")
return false 
end
if tonumber(userid) == tonumber(1737072779) then  
send(msg.chat_id_, msg.id_, " 👽 لا تسطيع كتم جاكسون الكبير عام")
return false 
end
if tonumber(userid) == tonumber(1842376997) then  
send(msg.chat_id_, msg.id_, " 👽 لا تسطيع كتم جاكسون الاجنبي عام")
return false 
end
...
t = ' 👽 ملفات السورس اسفينكس𖤍━┅┄⟞⟦꧁ASFINX ꧂⟧⟝┄┉━𖤍\n 𖤍━┅┄⟞⟦꧁ASFINX ꧂⟧⟝┄┉━𖤍 \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if Get_info then
local TextS = "\n 👽 اهلا بك في متجر ملفات اسفينكس\n 👽 ملفات السورس 𖤍━┅┄⟞⟦꧁ASFINX ꧂⟧⟝┄┉━𖤍\n◤━───━??𝗼𝗼𝗼𝗻━───━◥\n\n"
local TextE = "\n𖤍━┅┄⟞⟦꧁ASFINX ꧂⟧⟝┄┉━𖤍\n 👽 علامة تعني { ✔️ } ملف مفعل\n 👽 علامة تعني { ✖ } ملف معطل\n 👽 قناة سورس اسفينكس𖤍━┅┄⟞⟦꧁ASFINX ꧂⟧⟝┄┉━𖤍\n".." 👽 [اضغط هنا لدخول](t.me/mmmmm_70) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 👽 عذرا الملف لايدعم سورس اسفينكس\n") 
end
return false
end
...
if #list == 0 then
t = " 👽 لا يوجد احد في قائمه اسفينكس"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
'\n❲[《𝐒》ASFINX🌺  ](t.me/mmmmm_70)❳'..
'\n𖤍━┅┄⟞⟦꧁ASFINX ꧂⟧⟝┄┉━𖤍'..
'\n 👽 اعدادات الجروب كتالي ☆𖤍━┅┄⟞⟦꧁ASFINX ꧂⟧⟝┄┉━𖤍'..
'\nء𖤍━┅┄⟞⟦꧁ASFINX ꧂⟧⟝┄┉━𖤍'..
'\n 👽  علامة ال {✓} تعني مفعل'..
'\n 👽  علامة ال {✘} تعني معطل'..
'\nء𖤍━┅┄⟞⟦꧁ASFINX ꧂⟧⟝┄┉━𖤍'..
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..👽♥️](t.me/mmmmm_70)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤👽](t.me/mmmmm_70)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..👽💕](t.me/mmmmm_70)')
return false
end
end
end
...
↑𖤍━┅┄⟞⟦꧁ASFINX ꧂⟧⟝┄┉━𖤍𝙄𝘿 ➱ #id
↑𖤍━┅┄⟞⟦꧁ASFINX ꧂⟧⟝┄┉━𖤍𝙍𝘼𝙉𝙆 ➱  #stast 👽  
↑𖤍━┅┄⟞⟦꧁ASFINX ꧂⟧⟝┄┉━𖤍𝙈𝘼𝙎𝙂 ➱ #msgs 👽  
↑𖤍━┅┄⟞⟦꧁ASFINX ꧂⟧⟝┄┉━𖤍𝗖𝗛 ➯  ↝mmmmm_70↜ 👽  
]],
[[
𝟓 𝟔 𖡻 #username  ࿇🦄
𝟓 𝟔 𖡻 #msgs  ࿇🦄
...
local Teext =[[
 👽مرحب  بك في مميزات سورس اسفينكس 👽
 👽 مميزات الخاصه بسورس 👽
]]
keyboard = {} 
keyboard.inline_keyboard = {
